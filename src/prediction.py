...
def evaluate_model(model, dataloader, bos_token, common_id2word, cuda, max_iter_num, use_cfg):
...
if __name__ == '__main__':
    ...
    model = DECOM(config.d_model, config.d_ff, config.head_num, config.encoder_layer_num, config.decoder_layer_num,
                  ...
                  config.beam_width, use_cfg=config.use_cfg, fusion_mode=config.fusion_mode)
